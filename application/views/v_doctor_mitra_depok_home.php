  ...
  <div class="container">
        <div class='.col-xs-12 .col-sm-6 .col-md-8'>
          <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url() . 'c_doctor_mitra/mitra_depok' ?>">Data</a></li>
                <li><a href="<?php echo base_url() . 'c_doctor_mitra_schedule/mitra_depok' ?>">Schedule</a></li>
              </ol>
            <div class="panel panel-default">
                ...
                <div class="panel-heading"><h3>Hospital Information</h3></div>
                  <div class="panel-body">
                    ...
                    <h4>Website: </h4> <a href="<?php echo $data['website'];?>"> <?php echo $data['website'];?> </a>
                    <?php } ?>
                  </div>
               </div>
           </div>
