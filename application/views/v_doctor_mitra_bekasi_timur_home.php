	...
	<div class="container">
        <div class='.col-xs-12 .col-sm-6 .col-md-8'>
          <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url() . 'c_doctor_mitra/mitra_bekasi_timur' ?>">Data</a></li>
                <li><a href="<?php echo base_url() . 'c_doctor_mitra_schedule/mitra_bekasi_timur' ?>">Schedule</a></li>
              </ol>
